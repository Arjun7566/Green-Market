...
<nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <a class="float-left" href="bhome.php">
                <img src="ag.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
            </a>
        </div>
        ...
        <a class="float-left" href="bhome.php">
            <img src="ag.png" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
        </a>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Arjun Patidar</h4>
                        <p class="card-text text-center">NITT, Tamil Naidu<br><br>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Ram Rajput</h4>
                        <p class="card-text text-center">Harda, Madhya Pradesh<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Milan Gupta</h4>
                        <p class="card-text text-center">Indore, MP<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Anand</h4>
                        <p class="card-text text-center">Mumbai, Maharashtra<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        <h5 class="card-title text-center"><img src="iconbig2.png" style=" margin-bottom:  10px;"></h5>
                        <h4 class="card-subtitle mb-2  text-center">Hariom Pawar</h4>
                        <p class="card-text text-center">Banglore, Karnataka<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        <h5 class="card-title text-center"><img src="iconbig2.png" style=" margin-bottom:  10px;"></h5>
                        <h4 class="card-subtitle mb-2  text-center">Dhiraj Parihar</h4>
                        <p class="card-text text-center">Indore, MP<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
               ...
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5">
                              <ul class="list-unstyled list-inline social text-center">
                                   <li class="list-inline-item"><a href="https://www.facebook.com/ap7566933979"><i class="fa fa-facebook"></i></a></li>
                                   <li class="list-inline-item"><a href="https://twitter.com/anonymous_15110"><i class="fa fa-twitter"></i></a></li>
                                   <li class="list-inline-item"><a href="https://www.instagram.com/arjunpatidar__015/"><i class="fa fa-instagram"></i></a></li>
                                   <li class="list-inline-item"><a href="https://www.linkedin.com/in/arjun-patidar-762089261/;"><i class="fa fa-linkedin"></i></a></li>
                                   <li class="list-inline-item"><a href="mailto:arjun.patidar7566@gmail.com"><i class="fa fa-envelope"></i></a></li>
                              </ul>
                         </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                              <p> Green Market connecting farmers accross globe</p>
                              <p class="h6">created by~ ARJUN</p>
                         </div>
                         </hr>
                    </div>
               </div>
