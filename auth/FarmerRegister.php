...
if (isset($_POST['register'])) {
    ...
    $query1="select * from farmerregistration where farmer_phone='$phonenumber'";
    $run_query1 = mysqli_query($con, $query1);
    $count_rows = mysqli_num_rows($run_query1);

    if ($count_rows >0) {
        echo "<script>alert('Mobile Number already exist: Try login');</script>";
        ...
        $query2 = "insert into farmerregistration (farmer_name,farmer_phone,
        ...
        $run_register_query = mysqli_query($con, $query2);
