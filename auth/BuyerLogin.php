                    ...
                    <div class="card">
                        ...
                        <div class="card-body border border-dark">
                            <form name="my-form" action="BuyerLogin.php" method="post">
                                ...
                                <label  class="col-md-4 col-form-label text-md-right"><b>Enter captcha:</b></label>

								<div class="form-row">
									<div class="form-group col-md-4 col-form-label text-md-right mr-2 captcha">
										<div class="captcha"><?php echo $rand; ?></div>

									</div>
									<div class="form-group col-md-3">
										<input type="text" class="form-control" id="captcha" name="captcha" type="captcha" placeholder="captcha" required>
...
if (isset($_POST['login'])) {
	...
	$capt= $_REQUEST['captcha'];
	$captr= $_REQUEST['captcha-rand'];
